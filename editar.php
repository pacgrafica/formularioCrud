...
<head>
    ...
    <title>Editar Usuario registrado</title>
...
<body>
    <div class="container-fluid">
        ...
        <div class="row g-1" style="padding: 50px;" id="tabla">
                        ...
                        <div class="col-12 col-sm-4 col-md-4" style="border-style: ridge; "><?php echo $row["email"];?></div>
                        ...
                        <div class="col-12 col-sm-1 col-md-1" style="border-style: ridge; ">
                            <a href="actualizar.php?id=<?php echo $row["id"];?>" target="_self">
                                <i class="fa-solid fa-circle-arrow-left"> editar</i>
                            </a>
                            <a href="eliminar.php" target="_self">
                                <i class="fa-solid fa-circle-arrow-left"> eliminar</i>
                            </a>
                        </div>
                    <?php } ?>
